    ...
    return (
        ...
        <form onSubmit={handleSubmit}>                   
                <div className="form-floating mt-2 mb-2">    
                    <input className="form-control w-70" id="inputTitle" onChange={(e)=> setTitle(e.target.value)} value={title} type="text" placeholder="Title"/>
                ...
                <div className="form-floating mt-2 mb-2">    
                    <select className="form-select form-control w-70" id="floatingCat" onChange={(e)=> setCategory(e.target.value)}>
                ...
                <div className="form-floating mt-2 mb-2">    
                    <select className="form-select form-control w-70" id="floatingDistrict" onChange={(e)=> setDistrict(e.target.value)}>
                ...
                <div className="input mt-2 mb-7">    
                    ...
                    <input className="form-control w-70" id="fileUpload" onChange={handlePhoto2} type="file" placeholder="Image" accept=".jpeg, .png, .jpg"/>
                    <input className="form-control w-70" id="fileUpload" onChange={handlePhoto3} type="file" placeholder="Image" accept=".jpeg, .png, .jpg"/>
                </div>
                ...
                {photo2 ? <img className="img-thumbnail w-25 p-3 mt-2 mb-7" src={photo2} alt=""/> : <img className="mt-2" src="https://via.placeholder.com/400x250.png?text=No+Image+Selected" alt=""/>}
                {photo3 ? <img className="img-thumbnail w-25 p-3 mt-2 mb-7" src={photo3} alt=""/> : <img className="mt-2" src="https://via.placeholder.com/400x250.png?text=No+Image+Selected" alt=""/>}
            <br/>
            <br/>
            {alertmsg} 
            <div class="d-grid gap-2 col-6 mx-auto">
                <button className="btn btn-dark text-white mt-4 mb-5" onClick={handleSubmit} href="./" >Add Property</button>
            </div>
        </form>
    </div>
    );
